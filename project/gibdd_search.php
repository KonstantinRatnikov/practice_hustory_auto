<?php
    ...
    $vin = $_SESSION['vin'];
    $link = mysqli_connect("localhost","root","kostya.1100","practice");
    ...
    $command ='python3 /var/www/site1/main.py '.$vin.' '.$token1.' '.$code1.' '.$token2.' '.$code2.' '.$token3.' '.$code3.' '.$token4.' '.$code4;
    //echo($command);
    //echo("<br>");
    ...
    //Диагностика
    $command_dk = 'python3 /var/www/site1/dk.py '.$vin.' '.$token5.' '.$code5;
    exec($command, $exec_res);
